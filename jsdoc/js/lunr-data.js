window.lunrData = {
  ...
  "store": {
    ...
    "Router.html": {
      ...
      "tags": "Router",
      "summary": "",
      "description": "Routers map faux-URLs to actions, and fire events when routes arematched. Creating a new one sets its routes hash, if not set statically.Supports passing routes to the constructor as well as a transition flag.",
      "body": ""
    },
    "Router.html#view": {
      "id": "Router.html#view",
